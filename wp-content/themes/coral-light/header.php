...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header grid-container" role="banner">
		...
		<div id="headerright" class="grid-parent egrid <?php coral_light_header_right_class(); ?>">
			...
			<?php 
				$youtubeurl = get_theme_mod('coral_light_youtube_url_setting');
				$feedurl = get_theme_mod('coral_light_feed_url_setting');
				$twitterurl = get_theme_mod('coral_light_twitter_url_setting');
				$googleurl = get_theme_mod('coral_light_google_url_setting');
				$facebookurl = get_theme_mod('coral_light_facebook_url_setting');
			?>
			<?php if($youtubeurl) : ?>
